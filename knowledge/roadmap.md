...
(C1–C3 shipped — every provider now shares one date-alignment contract, and RCA
publishes the exact Shapley value), remaining statistical rigor (T11), UI trust
