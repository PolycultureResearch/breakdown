...
(C1–C4 shipped — every provider now shares one date-alignment contract, RCA
publishes the exact Shapley value, and the window bootstrap's finite-sample
attenuation is corrected), remaining statistical rigor (T11), UI trust finish
