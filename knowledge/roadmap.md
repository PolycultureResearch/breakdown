...
**Not yet built** (the roadmap below): the Horizon 0 correctness gate, remaining
statistical rigor (T11), UI trust finish (U5–U6), the connectivity kit, and the
market-driven items (scheduled monitoring, the rest of dimensional slicing).
