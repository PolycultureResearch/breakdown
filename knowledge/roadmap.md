...
noise, duplicate metric names are rejected at parse time, and cold-start belief
draws respect their declared bounds; **C8–C10 remain**), remaining
...
so it is substituted and disclosed rather than withheld. **C8 is next.**
